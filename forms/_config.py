...
class Ui_Config(object):
    def setupUi(self, Config):
        ...
        self.owner = QtWidgets.QLineEdit(Config)
        self.owner.setGeometry(QtCore.QRect(420, 40, 361, 25))
        self.owner.setObjectName("owner")
        self.label_10 = QtWidgets.QLabel(Config)
        self.label_10.setGeometry(QtCore.QRect(420, 20, 161, 16))
    ...
    def retranslateUi(self, Config):
        ...
        Config.setWindowTitle(_translate("Config", "Konfigurasi"))
        ...
        self.owner.setText(_translate("Config", "Petra Campus Radio"))
        self.label_10.setText(_translate("Config", "Program Header:"))
